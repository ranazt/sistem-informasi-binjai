...
<br><br>
<h1 class="text-center fw-bold mb-2 py-5 text-white">INFORMASI PENDUDUK</h1>
 <a href="inputp.php">Tambah Informasi Penduduk</a><br>
    <div class="container">
      ...
      while ($data = mysqli_fetch_assoc($proses)) {
        ...
        <div class="col">
          <div class="card h-100">
            <?php ['nama']; ?>
            <a href="tampilp.php?id=<?php echo $data['id']; ?>"><img src="foto/<?php echo $data['nama_file']; ?>" width="300" height="300"
                class="img-fluid"></a></a>
            <div class="card-body">
              ...
              <p class="card-text">
                ...
                ?>
               <br>
               <a href="ubahp.php?x=<?php echo $data['id']; ?>">Ubah</a>
                <a href="hapusp.php?id=<?php echo $data['id']; ?>">HAPUS</a>
            </div>
