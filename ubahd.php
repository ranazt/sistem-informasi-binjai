...
<head>
  ...
  <title>Dana Penghasilan Utama - Ubah Data</title>
...
<body>
  ...
  <br><br><br><br>
  <h1 class="text-center fw-bold mb-2 py-5 text-black">Ubah Data Dana Informasi Utama</h1>
  <?php
  include("koneksi.php");
  ...
  ?>
      <div class="container">
        <form action="updated.php" method="POST">
          ...
          <div class="mb-3">
            <label for="alamat" class="form-label">Periode Tahun</label>
