...
<body>
  ...
  <a href="inputd.php">Tambah Dana Penghasilan Utama</a><br>
  <div class="container">
      ...
      while ($data = mysqli_fetch_assoc($proses)) {
        ...
        <div class="col">
          <div class="card h-100">
            <?php ['nama']; ?>
            <a href="tampild.php?id=<?php echo $data['id']; ?>"><img src="foto/<?php echo $data['nama_file']; ?>" width="300" height="300"
                class="img-fluid"></a></a>
            <div class="card-body">
              ...
              <p class="card-text">
                ...
                ?>
                <br>
                <a href="ubahd.php?x=<?php echo $data['id']; ?>">Ubah</a>
                <a href="hapusd.php?id=<?php echo $data['id']; ?>">HAPUS</a>
            </div>
          </div>
        </div>
      <?php
